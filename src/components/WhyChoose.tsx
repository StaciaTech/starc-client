...
import { useNavigate } from "react-router-dom";
import star from "../Assets/picture.png";
import opp from "../Assets/opicon.png";
import learning from "../assests/learn.png";
import global from "../Assets/global.png";
import course from "../Assets/courses.png";
...
const WhyChoose: React.FC = () => {
  ...
  // Handle video auto-play with IntersectionObserver
  useEffect(() => {
    ...
    // Handle user play (to allow auto-play again if user resumes)
    const handlePlay = () => {
      ...
      (entries) => {
        entries.forEach((entry) => {
          if (entry.isIntersecting && !isUserPaused) {
            ...
            videoElement.pause();
            setIsUserPaused(false); // Reset pause state when video leaves viewport
          }
        });
      },
              ...
              <div className="w-[56.25%] rounded-2xl overflow-hidden shadow-lg">
                <div className="relative w-full" style={{ paddingBottom: "177.78%" }}>
                  <video
                    ...
                    poster={star}
                    loop
                    muted // Added for browser auto-play compatibility
                    preload="metadata"
                    onLoadedData={() => setVideoLoaded(true)}
                    onError={(e) => {
                      console.error("Error loading video:", e);
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-center w-full h-full">
            ...
            <div className="flex flex-col gap-6 h-full justify-end pb-[20%] items-end">
              ...
              <div className="w-[70%] grid grid-cols-1 bg-white rounded-3xl lg:p-1 3xl:p-4 shadow-2xl lg:text-xs xl:text-sm 2xl:text-base">
                ...
                <h3 className="font-semibold lg:text-[10px] xl:text-sm 2xl:text-base text-gray-900 mb-2 text-center">
                  Courses
                </h3>
                <p className="lg:text-[8px] xl:text-sm text-gray-600 lg:mb-2 3xl:mb-4 text-center">
                  Access a wide array of meticulously crafted courses.
                </p>
                <div className="flex items-center justify-center">
                  <button
                    className="bg-[#8A63FF] flex items-center align-center text-white px-4 py-2 rounded-3xl lg:text-[8px] xl:text-sm 2xl:text-base hover:bg-opacity-85"
                    onClick={() => navigate("/course")}
                  >
                    Courses
                  </button>
              ...
              <div className="w-[70%] bg-white rounded-3xl p-1 shadow-2xl mt-6">
                <div className="flex items-center gap-2 lg:p-1 3xl:p-4">
                  ...
                  <div className="flex items-start justify-start flex-col">
                    <div className="lg:text-[10px] xl:text-sm 2xl:text-[1.25rem] font-semibold text-gray-900 text-left">
                      100K+
                    </div>
                    <p className="lg:text-[8px] xl:text-sm text-gray-600 text-left">Join 100,000+ learners globally.</p>
                  </div>
            ...
            <div className="flex flex-col justify-start h-full pt-[20%] gap-6 items-start">
              ...
              <div className="w-[70%] bg-white rounded-xl lg:p-3 xl:p-4 3xl:p-6 shadow-2xl mb-6 flex">
                ...
                <div className="flex justify-center items-center">
                  <h3 className="font-semibold text-gray-900 lg:text-[10px] xl:text-sm 2xl:text-[1.25rem]">
                    Opportunities
                  </h3>
                </div>
              </div>
              ...
              <div className="w-[70%] bg-white rounded-2xl lg:p-3 xl:p-4 3xl:p-6 shadow-2xl">
                ...
                <h3 className="font-semibold text-gray-900 mb-2 text-center lg:text-[10px] xl:text-sm 2xl:text-[1.25rem]">
                  Learning
                </h3>
                <p className="text-gray-600 text-center lg:text-[8px] xl:text-sm">
                  Engage with interactive content, expert instructors.
                </p>
              </div>
            </div>
          </div>
