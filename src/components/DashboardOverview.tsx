...
const DashboardOverview: React.FC = memo(() => {
      ...
      try {
        ...
        setHasActivity(
          userActivityData.coursesEnrolled > 0 ||
            ...
            (userActivityData.recentActivity &&
              userActivityData.recentActivity.length > 0),
        );
      } catch (err) {
  ...
  return (
    <div
      className="w-full max-w-full mx-auto px-2 sm:px-4 py-4 overflow-y-auto"
      style={{ scrollbarWidth: "none" }}
    >
      <h1 className="text-xl sm:text-2xl md:text-3xl font-bold text-[#8A63FF] mb-4 md:mb-6 truncate">
        Hello {userName} 👋
      </h1>
      ...
      {hasActivity ? (
        <>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 gap-3 md:gap-4">
            ...
            <div className="bg-white rounded-xl shadow p-3 sm:p-4 col-span-1 sm:col-span-2 lg:col-span-2 xl:col-span-1">
              <div className="flex flex-col items-center">
                <h3 className="text-gray-700 text-sm font-medium mb-2 sm:mb-3 truncate">
                  Courses Enrolled
                </h3>
